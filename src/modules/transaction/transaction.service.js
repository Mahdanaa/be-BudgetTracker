...
class TransactionService {
  ...
  async getById(id) {
    ...
    if (!transaction) throw new NotFound('Data Transaction tidak ditemukan');
    return transaction;
  }
  ...
  async getMonthlySummary(userId) {
    ...
    const saving = Math.floor(Math.max(0, totalIncome - totalExpense) * 0.3 + totalIncome * 0.5);
